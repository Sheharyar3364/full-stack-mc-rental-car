...
Thank you for booking with **MC Rental Cars**! Your booking has been confirmed and we're excited to have you as our customer.
...
**Rental Period:** {{ $booking->pickup_date->format('M d, Y') }} to {{ $booking->dropoff_date->format('M d, Y') }} ({{ $booking->total_days }} days)
